...
grid_search = GridSearchCV(LogisticRegression(random_state=42), param_grid, cv=3, n_jobs=-1, verbose=1)
...
print(f"Precisión del modelo con los mejores parámetros (Logistic Regression): {accuracy * 100:.2f}%")
...
plt.title("Matriz de Confusión por Palabra (Logistic Regression)")
plt.tight_layout()
plt.show()

# Mostrar los mejores parámetros
print("Mejores parámetros encontrados (Logistic Regression):")
print(grid_search.best_params_)

# Guardar modelo y vectorizador si se desea
# joblib.dump(best_model, "modelo_transcriptor_logreg_best.pkl")
